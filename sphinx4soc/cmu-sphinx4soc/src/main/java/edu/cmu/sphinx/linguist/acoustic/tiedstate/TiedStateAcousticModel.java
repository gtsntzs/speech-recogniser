...
public class TiedStateAcousticModel implements AcousticModel
{
    ...
    static final Logger logger = Logger.getLogger( TiedStateAcousticModel.class );
    ...
    public void init ( Loader loader, UnitManager unitManager, boolean useComposites )
    {
        this.loader = loader;
        this.unitManager = unitManager;
        this.useComposites = useComposites;
    ...
    {
        if ( !allocated ) {
            logger.info( "Allocating TiedStateAcousticModel" );
    ...
    public HMM lookupNearestHMM ( Unit unit, HMMPosition position, boolean exactMatch )
    {
        ...
        if ( exactMatch ) {
            ...
            if ( hmm==null ) {
                ...
                if ( ciUnit==null ) {
                    logger.error( "Can't find HMM for "+unit.getName() );
                }
                assert ciUnit!=null;
...
//        if ( logger.isLoggable( Level.FINE ) ) {
        logger.info( "getCompositeSenoneSequence: "+unit+( compositeSenoneSequence==null ? "" : "Cached" ) );
//        }
...
//                    if ( logger.isLoggable( Level.FINE ) ) {
                    logger.info( "collected: "+hmm.getUnit() );
//                    }
...
//        }
    ...
    protected void logInfo ()
    {
        ...
        logger.info( "CompositeSenoneSequences: "+compositeSenoneSequenceCache.size() );
    }
