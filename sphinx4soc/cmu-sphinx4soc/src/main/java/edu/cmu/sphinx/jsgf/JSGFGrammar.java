...
{
    static final Logger logger = Logger.getLogger( JSGFGrammar.class );
    ...
    {
        this( LoadResourceUtils.load( location ), logMath,
...
//        logger = ps.getLogger();
    ...
    {
        logger.info( "Creating JSFGGrammar" );
        try {
            commitChanges();
...
//        }
    ...
    private GrammarGraph processRuleName ( JSGFRuleName initialRuleName )
            throws JSGFGrammarException
    {
//        logger.info( "parseRuleName: "+initialRuleName );
    ...
    private GrammarGraph processRuleCount ( JSGFRuleCount ruleCount )
            throws JSGFGrammarException
    {
//        logger.info( "parseRuleCount: "+ruleCount );
    ...
    {
//        logger.info( "parseRuleAlternatives: "+ruleAlternatives );
        GrammarGraph result = new GrammarGraph();
...
//        logger.info( "parseRuleSequence: "+ruleSequence );
    ...
    private GrammarGraph processRuleTag ( JSGFRuleTag ruleTag )
            throws JSGFGrammarException
    {
//        logger.info( "parseRuleTag: "+ruleTag );
