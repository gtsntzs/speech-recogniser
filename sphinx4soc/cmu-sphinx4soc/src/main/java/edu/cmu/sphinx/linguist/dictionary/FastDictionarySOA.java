 ...
 */
public class FastDictionarySOA implements Dictionary
{
    /**
    ...
    public FastDictionarySOA (
            ...
            UnitManager unitManager ) throws MalformedURLException, ClassNotFoundException
    {
        this(
    ...
    {
        System.out.println("Allocating Dictionary-----------------------------------------------");
        if ( !allocated ) {
...
//            loadTimer.stop();
     ...
     */
    public void loadDictionary ( InputStream inputStream, boolean isFillerDict )
            //    public void loadDictionary ( Exchange ex )
            throws IOException
    {
