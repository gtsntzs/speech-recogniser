 ...
 */
public class StreamCepstrumSource extends BaseDataProcessor implements DataProvider
{
    ...
    public Data getData () throws DataProcessingException
    {
        ...
        if ( curPoint==-1 ) {
            ...
            data = new FloatData( vectorData, sampleRate, collectTime, firstSampleNumber );
