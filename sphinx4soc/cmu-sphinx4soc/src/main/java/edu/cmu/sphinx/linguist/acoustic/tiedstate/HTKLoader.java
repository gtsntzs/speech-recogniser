...
{
    static final Logger logger = Logger.getLogger( HTKLoader.class );
...
//        logger = ps.getLogger();
    ...
    private void loadModelFiles ( String MMFname ) throws IOException
    {
        ...
        logger.info( "Loading HTK acoustic model: "+MMFname );
...
//                }
    ...
    public void logInfo ()
    {
        ...
        if ( meanTransformationMatrixPool!=null ) {
            meanTransformationMatrixPool.logInfo();
        }
        if ( meanTransformationVectorPool!=null ) {
            meanTransformationVectorPool.logInfo();
        }
