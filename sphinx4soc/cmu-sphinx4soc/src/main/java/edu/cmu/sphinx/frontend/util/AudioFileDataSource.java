 ...
 */
public class AudioFileDataSource extends BaseDataProcessor implements DataProvider
{
    ...
    public void create ( int bytesPerRead, List<AudioFileProcessListener> listeners )
    {
    ...
    public void setInputStream ( AudioInputStream inputStream, String streamName )
    {
        ...
        logger.log( Level.FINER, "input format is {0}", s );
	...
	public List<AudioFileProcessListener> getFileListeners() {
