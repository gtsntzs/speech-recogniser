...
public class SpeechClassifiedData implements Data, Cloneable
{
    ...
    @Override
    public SpeechClassifiedData clone () throws CloneNotSupportedException
    {
        try {
            return new SpeechClassifiedData( this.data.clone(), this.isSpeech );
