...
public class SpeedTracker implements ResultListener, Resetable, StateListener, SignalListener, Monitor
{
    ...
    {
        System.out.print( "   This  Time Audio: "+timeFormat.format( audioTime )+'s' );
        System.out.print( "  Proc: "+timeFormat.format( processingTime )+'s' );
        System.out.println( "  Speed: "+timeFormat.format( getSpeed() )+" X real time" );
        showAudioSummary();
    }
    ...
    {
        System.out.print( "   Total Time Audio: "+timeFormat.format( totalAudioTime )+'s' );
        System.out.print( "  Proc: "+timeFormat.format( totalProcessingTime )+'s' );
        System.out.println( "  Speed: "+timeFormat.format( getCumulativeSpeed() )+" X real time" );

        if ( showResponseTime ) {
            float avgResponseTime = (float)totalResponseTime/( numUtteranceStart*1000 );
            System.out.println( "   Response Time:  Avg: "+avgResponseTime+'s'
