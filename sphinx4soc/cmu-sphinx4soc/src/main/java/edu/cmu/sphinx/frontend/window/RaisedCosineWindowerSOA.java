...
// * @see Data
// */
//public class RaisedCosineWindowerSOA extends BaseDataProcessor
//{
...
//
//    public RaisedCosineWindowerSOA ( double alpha, float windowSizeInMs, float windowShiftInMs )
//    {
//        initLogger();
//        this.alpha = alpha;
...
//    }
//
//    public RaisedCosineWindowerSOA ()
//    {
//    }
//
//    @Override
...
//    }
//
//    public void proccessData ( Data input ) throws DataProcessingException
//    {
//        getTimer().start();
//
...
//                System.arraycopy( in, 0, allSamples, overflowBuffer.getOccupancy(), length );
...
//            outputQueue.add( new DoubleData( myWindow, sampleRate, currentCollectTime, currentFirstSampleNumber ) );
