...
{
    static final Logger log = Logger.getLogger( LexTreeLinguist.class );
...
//        languageModel.stop();
    ...
    private SearchState getInitialSearchState ()
    {
        ...
        return new LexTreeWordState( node, node.getParent(), ( new WordSequence( sentenceStartWordArray ) ).trim( maxDepth-1 ), 0f, logOne, logOne, false );
    }
    ...
    abstract class LexTreeState implements SearchState, SearchStateArc
    {
        ...
        public boolean equals ( Object o )
        {
            if ( o==this ) {
                ...
                boolean wordSequenceMatch = collapsed||wordSequence.equals( other.wordSequence );
        ...
        SearchStateArc createUnitStateArc ( HMMNode hmmNode, LexTreeState previous )
        {
            ...
            if ( generateUnitStates ) {
                arc = new LexTreeUnitState( hmmNode, getWordHistory(), previous.getSmearTerm(), smearProbability, languageProbability,
                        insertionProbability, collapsed );
            } else {
                HMM hmm = hmmNode.getHMM();
                arc = new LexTreeHMMState( hmmNode, getWordHistory(), previous.getSmearTerm(), smearProbability, hmm.getInitialState(),
        ...
        SearchStateArc createEndUnitArc ( EndNode endNode, LexTreeState previous )
        {
            ...
            return new LexTreeEndUnitState( endNode, getWordHistory(), previous.getSmearTerm(), smearProbability,
                    languageProbability, insertionProbability, collapsed );
        }
    ...
    public class LexTreeUnitState extends LexTreeState implements UnitSearchState
    {
        ...
        public SearchStateArc[] getSuccessors ()
        {
            ...
            arcs[0] = new LexTreeHMMState( getHMMNode(), getWordHistory(), getSmearTerm(), getSmearProb(),
                    hmm.getInitialState(), logOne, logOne, parentNode, collapsed );
            return arcs;
        }
